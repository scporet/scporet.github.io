...
<br>
<p>Since we were on a tight schedule, we were not afforded enough time to walk the entire gravesite.  I really wanted to hoof it up to the memorial building to view the atrium and the military operations map, along with wall engravings and lists of the missing; which can be viewed <a href="https://www.abmc.gov/sites/default/files/publications/Florence.pdf" target="_blank">here</a>.  We kept close to the entrance, but I was able to catch some nice photo's of the view from the first plot and surrounding area.  The statue to the left is one of two 361st Regimental statues keeping watch over the gravesite.  It is located overlooking plot A (photo above).  There are 8 plots, symetrically alingned in formation of two-by-two, with a walking path up to the memorial building.  The visit was truly a welcome surprise for the tour group. </p>
<br>
